...
👩‍💻 Atualmente eu trabalho como [DEsenvolvedor] @ [DER | CentralIT]

🔎 Também sou curioso sobre [Web Apps, Inteligencia artificial, Desenvolvimento de soluções para aplicações WEB, voltadas para melhorer a integração de ferramentas com IA para aumentar a performance dos usuarios em suas taferas cotidianas]
