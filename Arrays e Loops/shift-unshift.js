...
nomesDeEstudantes.shift();7 //remove o primeiro elemento do array
console.log(nomesDeEstudantes)

nomesDeEstudantes.unshift('Fábio Alves Marques'); //adiciona um novo elemento ao início do array
console.log(nomesDeEstudantes);